...
function tileset_init() {
  ...
  tileset.background_img[4].src = "images/backgrounds/busted.png"; //added for Heroin Dusk
  tileset.background_img[4].onload = function() {tileset_onload();};
  
  tileset.background_img[5].src = "images/backgrounds/intsky.png"; //added for Heroin Dusk
  tileset.background_img[5].onload = function() {tileset_onload();};
  
  tileset.background_img[6].src = "images/backgrounds/hades.png"; //added for Ascension Adventure
  ...
  tileset.tile_img[20].src = "images/tiles/death_speaker_dead.png";

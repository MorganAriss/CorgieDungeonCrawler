...
var POWERUP_ICON_SIZE = 32;
var POWERUP_POS_X = 64;
var POWERUP_POS_Y = 88;

var treasure = new Object();
// duplicated and repurposed for power-up declaration
var powerUp = new Object();

treasure.img = new Image();
treasure.img_loaded = false;

// duplicated and repurposed for power-up image
powerUp.img = new Image();
powerUp.img_loaded = false;

treasure.gold_pos = new Array();
// duplicated and repurposed to create a new array for power-ups
powerUp.power_pos = new Array();

/*** Initialize **********************/
function treasure_init() {

  treasure.img.src = "images/treasure/treasure.png";
  treasure.img.onload = function () {
    treasure_img_onload();
  };
...
function powerUp_init() {
  ...
  powerUp.img.src = "images/treasure/powerups.png";
  powerUp.img.onload = function() {
    powerUp_img_onload();
  };

  powerUp.power_pos[0] = {dest_x: 65, dest_y: 93};
  powerUp.power_pos[1] = {dest_x: 56, dest_y: 96};
  powerUp.power_pos[2] = {dest_x: 74, dest_y: 95};
  powerUp.power_pos[3] = {dest_x: 74, dest_y: 86};
  powerUp.power_pos[4] = {dest_x: 50, dest_y: 80};
  powerUp.power_pos[5] = {dest_x: 63, dest_y: 78};
  powerUp.power_pos[6] = {dest_x: 41, dest_y: 92};
  powerUp.power_pos[7] = {dest_x: 90, dest_y: 76};
  powerUp.power_pos[8] = {dest_x: 87, dest_y: 94};
  powerUp.power_pos[9] = {dest_x: 29, dest_y: 77};
...
function powerUp_img_onload() {powerUp.img_loaded = true;}
...
function powerUp_render_power(item_id) {
  ctx.drawImage(
      powerUp.img,
      (item_id * TREASURE_ICON_SIZE) * PRESCALE,
      0,
